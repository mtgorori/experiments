...
%%%% 音速分布 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% 実測投影データ呼び出し%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('../result/projection_map_04.mat','projection')
%%%% 音速再構成 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
iteration = 30;
...
ylabel('平均二乗誤差[m/s]')
axis tight
exportfig('../result/ART_reconstruction7_MSE','png',[250,200]);
%%%% プロファイル表示　%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
...
hold off
exportfig('../result/ART_reconstruction7_profile','png',[300,300]);
%%%% 描画用その1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
subplot(1,2,1);
...
ylabel('y方向[mm]')
caxis([1350 1600])
exportfig('../result/ART_reconstruction7','png',[800,400]);
%%%% 描画用その2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ylabel('y方向[mm]')
caxis([1350 1600])
exportfig('../result/ART_reconstruction7_iter','png',[1000,450]);