...
plot(MSE(1,1:It));
xlabel('更新回数')
ylabel('平均二乗誤差[m^2s^{-2}]')
axis tight
exportfig('../result/ART_aic_window200_MSE','png',[250,200]);
%%%% プロファイル表示　%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
...
hold off
exportfig('../result/ART_aic_window200','png',[300,300]);
%%%% 描画用その1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
figure
subplot(1,2,1);
...
caxis([1350 1600])
toc
exportfig('../result/ART_aic_window200_1','png',[800,400]);
%%%% 描画用その2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% ylabel('y方向[mm]')
% caxis([1350 1600])
exportfig('../result/ART_aic_window200_iter','png',[600,450]);
