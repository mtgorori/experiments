...
%------------------------------------------------------------------------------------------------------
clear;close all
load("H:/data/kwave/result/2018_09_08_variousFrequency/Corrected/statistics.mat",'tof_cell')
...
ylabel('媒質番号')
zlabel('平均音速[m/s]')
exportfig("H:\result\2018_09_26_ltplot\correct\lt_from_signal_waterfall",'png',[400,400])
figure;
imagesc(v(:,:,1)');
xlabel('素子番号')
ylabel('媒質番号')
...
exportfig("H:\result\2018_09_26_ltplot\correct\lt_from_signal_imagesc",'png',[300,300])
%% 参照用のlt(=v)データの作成
...
xlabel('x軸[mm]')
ylabel('y軸[mm]')
exportfig("H:\result\2018_09_26_ltplot\correct\medium_case1",'png',[300,300]);
...
xlabel('x軸[mm]')
ylabel('y軸[mm]')
exportfig("H:\result\2018_09_26_ltplot\correct\refer_range_medium_case1",'png',[300,300]);
v_reference = zeros(t_num,model_num);
% 画素値平均化を行う
for jj = 1:model_num
...
xlabel('素子番号')
ylabel('媒質番号')
exportfig("H:\result\2018_09_26_ltplot\correct\lt_from_medium_waterfall_2MHz",'png',[300,300]);
figure;
