...
savePlot(filename = "//Azlab-fs01/東研究室/個人work/竹内(ひ)/result/2018_09_13_analyzeRealisticModel_R_multiFreq/residuals_vs_displaceFAS.png",type="png")
dev.off()
...
savePlot(filename = "//Azlab-fs01/東研究室/個人work/竹内(ひ)/result/2018_09_13_analyzeRealisticModel_R_multiFreq/residuals_vs_FWHM.png",type="png")
dev.off()
...
savePlot(filename = "//Azlab-fs01/東研究室/個人work/竹内(ひ)/result/2018_09_13_analyzeRealisticModel_R_multiFreq/var_diff_point_vs_refractive_dispersion.png",type="png")
dev.off()
...
savePlot(filename = "//Azlab-fs01/東研究室/個人work/竹内(ひ)/result/2018_09_13_analyzeRealisticModel_R_multiFreq/FWHM_vs_refractive_dispersion.png",type="png")
dev.off()