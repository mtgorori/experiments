...
%% 初期設定（共通）
clear
dst_path = sprintf('H:/result/2018_12_06_IMCL_direct_estimation/case66/2018_12_12_flow');
...
for mm = 1:num_medium
    for ll = 1:num_lateral
        ...
        pathname = sprintf('H:/data/kwave/result/2018_10_15_realisticScatter_variousIMCL_Correct/case66_IMCL0.0');
        cd(pathname);
        load('rfdata.mat');
        load('kgrid.mat');
        ...
        %% 保存部
        dst_path2 = sprintf('H:/result/2018_12_06_IMCL_direct_estimation/case66/2018_12_12_flow/IMCL%d%%',mm);
    ...
    load("H:/data/kwave/medium/2018_09_28_realisticScatter_variousIMCL/corrected/case66_IMCL0.0.mat");
    figure;
    ...
    c.Label.String = '[m/s]';
    set(gca,'YDir','normal');
    savefilename = sprintf('/case66_IMCL%0.1f_pure_boundary',ll);
    savefigname = sprintf('/case66_IMCL%0.1f_pure_boundary.fig',ll);
