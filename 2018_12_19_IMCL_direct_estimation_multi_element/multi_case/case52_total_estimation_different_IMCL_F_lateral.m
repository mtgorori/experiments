...
load("H:/experiments/2018_12_19_IMCL_direct_estimation_multi_element/multi_case/condition/2018_12_28_case52.mat")
...
for nn = 1
    loadfilename = sprintf("H:/result/2018_12_19_IMCL_direct_estimation_multi_element/multi_case/2018_12_28_variousF&lateral/case52IMCL%d%%/result.mat",IMCL_rate(nn));
    load(loadfilename);
...
for nn = 2:num_IMCL
    ...
    loadpath = sprintf('H:/data/kwave/result/2018_12_28_other_case_variousIMCL/case52_IMCL%0.1f',IMCL_rate(nn));
