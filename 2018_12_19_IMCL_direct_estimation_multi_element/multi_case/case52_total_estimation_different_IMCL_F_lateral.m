...
load("H:\data\kwave\medium\2019_01_24_realisticScatter_for_5MHz\case52_IMCL0.0.mat")
load("H:\data\kwave\result\2019_01_24_realisticScatter_for_5MHz\case52_IMCL0.0\rfdata.mat")
load("H:\data\kwave\result\2019_01_24_realisticScatter_for_5MHz\case52_IMCL0.0\kgrid.mat")
load("H:\experiments\2018_12_19_IMCL_direct_estimation_multi_element\multi_case\condition\2019_01_25_case52.mat")
% 音速値
v_fat        = 1450;%[m/s]
v_muscle = 1580;%[m/s]
...
for nn = 1:num_IMCL
    ...
    loadpath = sprintf('H:/data/kwave/result/2019_01_24_realisticScatter_for_5MHz/case52_IMCL%0.1f',IMCL_rate(nn));
