...
target_element      = linspace(1,100,100);
    ...
    for nn = 1:num_IMCL
        ...
        for  kk = 1:num_assumed_depth
            for ll = 1:num_assumed_SOS
                ...
                rfdata_echo_only = transmit_focus(rfdata_echo_only,linspace(1,num_receiver,num_receiver))
        ...
        % 画像保存%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        dst_path = sprintf('H:/result/2018_12_19_IMCL_direct_estimation_multi_element/wire/2018_12_18/2018_12_18_depth%0.1fmmIMCL%d%%',...
            boundary_depth(mm)*1e3,IMCL_rate(nn));
...
%% 保存部
dst_path2 = sprintf('H:/result/2018_12_19_IMCL_direct_estimation_multi_element/wire/2018_12_18/figure');
...
dst_path3 = sprintf('H:/result/2018_12_19_IMCL_direct_estimation_multi_element/wire/2018_12_18/');
