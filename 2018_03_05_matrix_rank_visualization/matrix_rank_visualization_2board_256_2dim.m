...
xlabel('x方向[mm]')
ylabel('y方向[mm]')
exportfig( 'H:\result\2018_03_05_matrix_rank_visualization\2019_01_15_matrix_rank_visualization_2board_256_2dim','png',[500,500]);
figure;
...
xlabel('x方向[mm]')
ylabel('経路密度')
exportfig( 'H:\result\2018_03_05_matrix_rank_visualization\2019_01_15_matrix_rank_visualization_2board_256_1dim_x','png',[300,300]);
figure;
plot(x_grid*1000,C(116, :));
xlim([-55 55])
ylim([0 900])
xlabel('x方向[mm]')
ylabel('経路密度')
exportfig( 'H:\result\2018_03_05_matrix_rank_visualization\2019_01_15_matrix_rank_visualization_2board_256_1dim_x_y=-5mm','png',[300,300]);
figure;
plot(y_grid*1000,C(:, 180));
xlim([-55 55])
ylim([0 900])
xlabel('y方向[mm]')
ylabel('経路密度')
exportfig( 'H:\result\2018_03_05_matrix_rank_visualization\2019_01_15_matrix_rank_visualization_2board_256_1dim_y','png',[300,300]);